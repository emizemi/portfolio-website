  ...
  return (
    ...
    >
      <div className="container">
        <div className="intro">
          <img src="images/emilio-two.png" style={{width: "220px", height: "220px"}} alt="Bolby" className="mb-4" />

          <h1 className="mb-2 mt-0">Emilio Encarnacion</h1>
          <p>
            Software Engineer
          </p>
          ...
          <ul className="social-icons light list-inline mb-0 mt-4">
            <li className="list-inline-item">
              <a href="https://www.linkedin.com/in/emilio-encarnacion/">
                <i className="fab fa-linkedin"></i>
              </a>
            </li>
            <li className="list-inline-item">
              <a href="https://github.com/emizemi">
